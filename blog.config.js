...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'PDSXMBook', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '项目手册📖', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://book.pdsxm.xyz', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '手册, 平顶山项目', // 网站关键词 英文逗号隔开

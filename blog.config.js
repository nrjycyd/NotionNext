...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'HNR', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '吾日三省吾身，为真性情', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.hnr1.space', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'HNR, 博客', // 网站关键词 英文逗号隔开
